...
class UserDAO extends DAO implements UserProviderInterface
{
     ...
     *
     * @return \OCBlog\Domain\User|throws an exception if no matching user is found
     */
     ...
     *
     * @param \OCBlog\Domain\User $user The user to save
     */
    ...
    {
        return 'OCBlog\Domain\User' === $class;
    }
